...
namespace CGL
{
    ...
    class RasterizerImp : public Rasterizer
    {
     private:
        ...
        bool check_inside(float px, float py, float x0, float y0, float x1, float y1, float x2, float y2);
     ...
     public:
        ...
        void set_psm(PixelSampleMethod p)
        {
            psm = p;
        }
        void set_lsm(LevelSampleMethod l)
        {
            lsm = l;
        }
